                        ...
                        angular.forEach(broker.children, function (child) {
                            ...
                            if (grandChildren) {
                                ...
                                angular.forEach(names, function (name) {
                                    var idx = _.findIndex(grandChildren, function (n) { return n.title === name; });
                                    if (idx > 0) {
                ...
                if (tree) {
                    ...
                    children.forEach(function (broker) {
                        ...
                        if (grandChildren) {
                            ...
                            var idx = _.findIndex(grandChildren, function (n) { return n.title === "Topic"; });
                            if (idx > 0) {
                                var old = grandChildren[idx];
        ...
        if (workspace) {
            ...
            if (tree && selection) {
                ...
                if (domain && contextId) {
                    ...
                    if (result && result.children) {
                        var mbean = _.find(result.children, function (m) { return _.startsWith(m.title, "BacklogTracer"); });
                        if (mbean) {
        ...
        if (workspace) {
            ...
            if (tree && selection) {
                ...
                if (domain && contextId) {
                    var result = tree.navigate(domain, contextId, "tracer");
                    if (result && result.children) {
                        var mbean = _.find(result.children, function (m) { return _.startsWith(m.title, "BacklogDebugger"); });
                        if (mbean) {
                            return mbean.objectName;
                        }
                    }
        ...
        if (workspace) {
            ...
            if (tree && selection) {
                ...
                if (domain && contextId) {
                    ...
                    if (result && result.children) {
                        var mbean = _.find(result.children, function (m) { return _.startsWith(m.title, "DefaultTypeConverter"); });
                        if (mbean) {
                            return mbean.objectName;
                        }
                    }
        ...
        if (workspace) {
            ...
            if (tree && selection) {
                ...
                if (domain && contextId) {
                    var result = tree.navigate(domain, contextId, "services");
                    if (result && result.children) {
                        var mbean = _.find(result.children, function (m) { return _.startsWith(m.title, "DefaultRestRegistry"); });
                        if (mbean) {
                            return mbean.objectName;
                        }
                    }
        ...
        if (workspace) {
            ...
            if (tree && selection) {
                ...
                if (domain && contextId) {
                    var result = tree.navigate(domain, contextId, "services");
                    if (result && result.children) {
                        var mbean = _.find(result.children, function (m) { return _.startsWith(m.title, "DefaultRuntimeEndpointRegistry"); });
                        if (mbean) {
                            return mbean.objectName;
                        }
                    }
        ...
        if (workspace) {
            ...
            if (tree && selection) {
                ...
                if (domain && contextId) {
                    var result = tree.navigate(domain, contextId, "services");
                    if (result && result.children) {
                        var mbean = _.find(result.children, function (m) { return _.startsWith(m.title, "DefaultInflightRepository"); });
                        if (mbean) {
                            return mbean.objectName;
                        }
                    }
        ...
        if (workspace) {
            ...
            if (tree && selection) {
                ...
                if (domain && contextId) {
                    var result = tree.navigate(domain, contextId, "services");
                    if (result && result.children) {
                        var mbean = _.find(result.children, function (m) { return _.startsWith(m.title, "DefaultAsyncProcessorAwaitManager"); });
                        if (mbean) {
                            return mbean.objectName;
                        }
                    }
        ...
        if (workspace) {
            ...
            if (tree && selection) {
                ...
                if (domain && contextId) {
                    var result = tree.navigate(domain, contextId, "services");
                    if (result && result.children) {
                        var mbean = _.find(result.children, function (m) { return _.startsWith(m.title, "MetricsRegistryService"); });
                        if (mbean) {
                            return mbean.objectName;
                        }
                    }
...
(function (Camel) {
    Camel._module.controller("Camel.BreadcrumbBarController", ["$scope", "$routeParams", "workspace", "jolokia", function ($scope, $routeParams, workspace, jolokia) {
            ...
            function findEndpoints(contextId) {
                ...
                if (contextFolder) {
                    var endpoints = _.find((contextFolder["children"] || []), function (n) { return "endpoints" === n.title; });
                    if (endpoints) {
            ...
            function findRoutes(contextId) {
                ...
                var contextFolder = Camel.getCamelContextFolder(workspace, contextId);
                if (contextFolder) {
                    var folders = _.find((contextFolder["children"] || []), function (n) { return "routes" === n.title; });
                    if (folders) {
...
(function (Karaf) {
    ...
    function setSelect(selection, group) {
        ...
        var answer = _.findIndex(group, function (item) {
    ...
    function getComponentByName(workspace, jolokia, componentName) {
        ...
        return _.find(components, function (c) {
