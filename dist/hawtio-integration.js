...
(function (Camel) {
    ...
    Camel._module.run(["HawtioNav", "workspace", "jolokia", "viewRegistry", "layoutFull", "helpRegistry", "preferencesRegistry", "$templateCache", "$location", "$rootScope", function (nav, workspace, jolokia, viewRegistry, layoutFull, helpRegistry, preferencesRegistry, $templateCache, $location, $rootScope) {
            ...
            // add sub level tabs
            // Do not add JMX tabs as they are already in the layout header
            // const subTabs = Jmx.getNavItems(builder, workspace, $templateCache, 'camel');
            var subTabs = [];
            subTabs.push(
            // special for route diagram as we want this to be the 1st
            {
                ...
                show: function () {
                    return (workspace.isRoute() || workspace.isRoutesFolder())
                ...
                show: function () {
                    return !workspace.isEndpointsFolder() && !workspace.isEndpoint()
                ...
                show: function () {
                    return !workspace.isEndpointsFolder()
                        && (workspace.isRoute() || workspace.isRoutesFolder())
                        && Camel.isCamelVersionEQGT(2, 15, workspace, jolokia)
                        && workspace.hasInvokeRightsForName(Camel.getSelectionCamelBlockedExchanges(workspace), "browse");
                },
            ...
            var tab = (_a = builder.id('camel')
                ...
                .href(function () { return myUrl; })
                .isValid(function () { return workspace.treeContainsDomainAndProperties(Camel.jmxDomain); })).tabs.apply(_a, [subTabs[0]].concat(subTabs.slice(1)))
                .build();
            nav.add(tab);
...
var Camel;
(function (Camel) {
    Camel._module.controller("Camel.PropertiesController", ["$scope", "$rootScope", "workspace", "localStorage", "jolokia",
        function ($scope, $rootScope, workspace, localStorage, jolokia) {
            var log = Logger.get("Camel");
...
(function (Osgi) {
    ...
    Osgi._module.run(["HawtioNav", "workspace", "viewRegistry", "helpRegistry", function (nav, workspace, viewRegistry, helpRegistry) {
            ...
            var configuration = builder.id('osgi-configuration')
                .href(function () { return '/osgi/configurations' + workspace.hash(); })
                .title(function () { return 'Configuration'; })
                .isSelected(function () { return workspace.isLinkPrefixActive('/osgi/configuration')
                || workspace.isLinkPrefixActive('/osgi/pid'); })
                .build();
            var bundles = builder.id('osgi-bundles')
                .href(function () { return '/osgi/bundle-list' + workspace.hash(); })
                .title(function () { return 'Bundles'; })
                .isSelected(function () { return workspace.isLinkPrefixActive('/osgi/bundle'); })
                .build();
            var features = builder.id('osgi-features')
                .href(function () { return '/osgi/features' + workspace.hash(); })
                .title(function () { return 'Features'; })
                .show(function () { return !Core.isBlank(Karaf.getSelectionFeaturesMBean(workspace)); })
                .isSelected(function () { return workspace.isLinkPrefixActive('/osgi/feature'); })
                .build();
            var packages = builder.id('osgi-packages')
                .href(function () { return '/osgi/packages' + workspace.hash(); })
                .title(function () { return 'Packages'; })
                .isSelected(function () { return workspace.isLinkPrefixActive('/osgi/package'); })
                .build();
            var services = builder.id('osgi-services')
                .href(function () { return '/osgi/services' + workspace.hash(); })
                .title(function () { return 'Services'; })
                .isSelected(function () { return workspace.isLinkPrefixActive('/osgi/service'); })
                .build();
            var scrComponents = builder.id('osgi-scr-components')
                .href(function () { return '/osgi/scr-components' + workspace.hash(); })
                .title(function () { return 'Declarative Services'; })
                .show(function () { return !Core.isBlank(Karaf.getSelectionScrMBean(workspace)); })
                .isSelected(function () { return workspace.isLinkPrefixActive('/osgi/scr-component'); })
                .build();
            var server = builder.id('osgi-server')
                .href(function () { return '/osgi/server' + workspace.hash(); })
                .title(function () { return 'Server'; })
                .isSelected(function () { return workspace.isLinkPrefixActive('/osgi/server'); })
                .build();
            var fwk = builder.id('osgi-fwk')
                .href(function () { return '/osgi/fwk' + workspace.hash(); })
                .title(function () { return 'Framework'; })
                .isSelected(function () { return workspace.isLinkPrefixActive('/osgi/fwk'); })
                .build();
            /*
    ...
    Osgi._module.controller("Osgi.BundleController", ["$scope", "$location", "workspace", "$routeParams", "jolokia", function ($scope, $location, workspace, $routeParams, jolokia) {
            ...
            function createImportPackageSection() {
                ...
                for (var pkg_1 in importPackageHeaders) {
                    if (importPackageHeaders[pkg_1] === undefined) {
                        continue;
                    }
                    ...
                    unsatisfied += "<li class=\"list-group-item\"><span id=\"unsatisfied." + pkg_1 + "\" class=\"label label-warning\">" + pkg_1 + "</span></li>";
                }
                if (unsatisfied !== "") {
            ...
            function updateServices(result) {
                ...
                for (var id in data) {
                    ...
                    jolokia.request({
                        ...
                        operation: 'getProperties', arguments: [id] }, Core.onSuccess(function (svcId, regEl, usesEl) {
    ...
    Osgi._module.controller("Osgi.ConfigurationsController", ["$scope", "$routeParams", "$location", "workspace", "jolokia",
        function ($scope, $routeParams, $location, workspace, jolokia) {
            ...
            function updateConfigurations() {
                ...
                $scope.configurations = _.sortBy(configurations, function (configuration) { return configuration.name.toLowerCase(); });
                Core.$apply($scope);
            }
            ...
            function updateMbeanAttribute(name, value) {
                ...
                if (mbean) {
                    workspace.jolokia.request({
                        ...
                        success: function (response) { return Core.notification("success", "Configuration updated"); }
                    });
                }
            }
...
(function (Osgi) {
    var OsgiGraphBuilder = (function () {
        function OsgiGraphBuilder(osgiDataService, workspace, bundleFilter, packageFilter, showServices, showPackages, hideUnused) {
        ...
        OsgiGraphBuilder.prototype.buildGraph = function () {
            ...
            if (this.hideUnused) {
                ...
                this.graphBuilder.filterNodes(function (node) { return node.used; });
                // this will remove all nodes that do not have connections after filtering the unused nodes
                this.graphBuilder.filterNodes(function (node) { return _this.graphBuilder.hasLinks(node.id); });
            }
...
(function (Osgi) {
    Osgi._module.controller("Osgi.PidController", ["$scope", "$timeout", "$routeParams", "$location", "workspace", "jolokia",
        function ($scope, $timeout, $routeParams, $location, workspace, jolokia) {
    ...
    Osgi._module.controller("Osgi.ServiceDependencyController", ["$scope", "$location", "$routeParams", "workspace", "osgiDataService", function ($scope, $location, $routeParams, workspace, osgiDataService) {
            ...
            */
            ...
            $scope.updateGraph = function () {
                ...
                var graphBuilder = new Osgi.OsgiGraphBuilder(osgiDataService, workspace, $scope.bundleFilter, $scope.packageFilter, $scope.selectView == "services", $scope.selectView == "packages", $scope.hideUnused);
...
$templateCache.put("plugins/activemq/html/layoutActiveMQTree.html","<div id=\"jmx-box\">\n  <div class=\"header\">\n\n    <div id=\"jmx-tree-controls\" class=\"pull-left\" ng-controller=\"ActiveMQ.TreeHeaderController\">\n      <i class=\"fa fa-chevron-down clickable\"\n         title=\"Expand all nodes\"\n         ng-click=\"expandAll()\"></i>\n      <i class=\"fa fa-chevron-up clickable\"\n         title=\"Unexpand all nodes\"\n         ng-click=\"contractAll()\"></i>\n    </div>\n\n    <div class=\"pull-right\" ng-include=\"\'plugins/jmx/html/subLevelTabs.html\'\"></div>\n\n    <ul class=\"nav nav-pills pull-right\" ng-controller=\"Jmx.TabController\">\n      <li class=\"nav-link\" ng-class=\"{active: isTabActive(\'jmx-attributes\')}\">\n        <a class=\"nav-link\" href=\"#\" ng-click=\"goto(\'/jmx/attributes\', \'jmx-attributes\')\">Attributes</a>\n      </li>\n      <li class=\"nav-link\" ng-class=\"{active: isTabActive(\'jmx-operations\')}\">\n        <a class=\"nav-link\" href=\"#\" ng-click=\"goto(\'/jmx/operations\', \'jmx-operations\')\">Operations</a>\n      </li>\n      <li class=\"nav-link\" ng-class=\"{active: isTabActive(\'jmx-chart\')}\">\n        <a class=\"nav-link\" href=\"#\" ng-click=\"goto(\'/jmx/charts\', \'jmx-chart\')\">Chart</a>\n      </li>\n      <li class=\"nav-link\" ng-class=\"{active: isTabActive(\'jmx-edit-chart\')}\">\n        <a class=\"nav-link\"\n           ng-class=\"{disabled: !isTabActive(\'jmx-chart\') && !isTabActive(\'jmx-edit-chart\')}\"\n           href=\"#\" ng-click=\"editChart()\">Edit Chart</a>\n      </li>\n    </ul>\n\n  </div>\n\n  <div class=\"main\">\n\n    <div id=\"tree-container\" ng-controller=\"Jmx.MBeansController\">\n      <div class=\"camel-tree\" ng-controller=\"ActiveMQ.TreeController\">\n        <div id=\"activemqtree\"></div>\n      </div>\n    </div>\n\n    <div id=\"properties\" ng-view></div>\n  </div>\n\n</div>\n");
...
$templateCache.put("plugins/osgi/html/bundles.html","<h1>Bundles</h1>\n\n<div class=\"controller-section\" ng-controller=\"Osgi.BundlesController\">\n\n  <div class=\"row toolbar-pf\">\n    <form class=\"toolbar-pf-actions\">\n      <div class=\"form-group\">\n        <label class=\"sr-only\" for=\"filter\">Install Bundle</label>\n        <div class=\"input-group\" hawtio-show object-name=\"{{frameworkMBean}}\" method-name=\"installBundle\">\n          <input type=\"text\" class=\"form-control\" placeholder=\"Install Bundle...\" ng-model=\"bundleUrl\">\n          <div class=\"input-group-btn\">\n            <button type=\"button\" class=\"btn btn-default\" ng-disabled=\"installDisabled()\" ng-click=\"install()\"\n                    title=\"Install\">\n              <i class=\"fa fa-download\"></i>\n            </button>\n          </div>\n        </div>\n      </div>\n      <div class=\"form-group\">\n        <input type=\"text\" class=\"form-control\" ng-model=\"gridOptions.filterOptions.filterText\" placeholder=\"Filter...\"\n               autocomplete=\"off\">\n      </div>\n      <div class=\"form-group\">\n        <div class=\"btn-group\">\n          <button type=\"button\" class=\"btn btn-default\" title=\"Stop\" ng-disabled=\"selected.length == 0\" ng-click=\"stop()\">\n            <i class=\"fa fa-power-off\"></i>\n          </button>\n          <button type=\"button\" class=\"btn btn-default\" title=\"Start\" ng-disabled=\"selected.length == 0\" ng-click=\"start()\">\n            <i class=\"fa fa-play-circle\"></i>\n          </button>\n          <button type=\"button\" class=\"btn btn-default\" title=\"Refresh\" ng-disabled=\"selected.length == 0\" ng-click=\"refresh()\">\n            <i class=\"fa fa-refresh\"></i>\n          </button>\n          <button type=\"button\" class=\"btn btn-default\" title=\"Update\" ng-disabled=\"selected.length == 0\" ng-click=\"update()\">\n            <i class=\"fa fa-cloud-download\"></i>\n          </button>\n          <button type=\"button\" class=\"btn btn-default\" title=\"Uninstall\" ng-disabled=\"selected.length == 0\" ng-click=\"uninstall()\">\n            <i class=\"fa fa-eject\"></i>\n          </button>\n        </div>\n      </div>\n      <div class=\"toolbar-pf-action-right\">\n        <div class=\"form-group toolbar-pf-view-selector\">\n          <a ng-href=\"{{listViewUrl}}\" class=\"btn btn-link\" title=\"Grid view\">\n            <i class=\"fa fa-th\"></i>\n          </a>\n          <a ng-href=\"{{tableViewUrl}}\" class=\"btn btn-link\" title=\"Table view\">\n            <i class=\"fa fa-table\"></i>\n          </a>\n        </div>\n      </div>\n    </form>\n  </div>\n\n  <div class=\"row\">\n    <div class=\"spinner spinner-lg loading-page\" ng-show=\"loading\"></div>\n    <table ng-hide=\"loading\" class=\"table table-striped table-bundles\" hawtio-simple-table=\"gridOptions\"></table>\n  </div>\n</div>\n");
$templateCache.put("plugins/osgi/html/configurations.html","<h1>Configuration</h1>\n\n<div id=\"osgi-configuration\" class=\"controller-section\" ng-controller=\"Osgi.ConfigurationsController\">\n  \n  <div class=\"row toolbar-pf\">\n    <form class=\"toolbar-pf-actions search-pf\">\n      <div class=\"form-group\">\n        <button class=\"btn btn-default\" ng-click=\"addPidDialog.open()\" title=\"Add a new configuration\" hawtio-show object-name=\"{{hawtioConfigAdminMBean}}\" method-name=\"configAdminUpdate\">\n          Add configuration\n        </button>\n      </div>\n      <div class=\"form-group has-clear\">\n        <div class=\"search-pf-input-group\">\n          <label for=\"search1\" class=\"sr-only\">Filter</label>\n          <input id=\"search1\" type=\"search\" class=\"form-control\" ng-model=\"filterText\" placeholder=\"Filter...\">\n          <button type=\"button\" class=\"clear\" aria-hidden=\"true\" ng-click=\"filterText = \'\'\"><span class=\"pficon pficon-close\"></span></button>\n        </div>\n      </div>\n    </form>\n  </div>\n\n  <div class=\"list-group list-view-pf list-view-pf-view\">\n    <div ng-repeat=\"configuration in configurations | filter:filterText\">\n      <div class=\"list-group-item list-view-pf-stacked\">\n        <div class=\"list-group-item-header\" ng-click=\"goTo(configuration.pidLink)\">\n          <div class=\"list-view-pf-main-info\">\n            <div class=\"list-view-pf-left\">\n              <span class=\"list-view-pf-icon-sm\" ng-class=\"configuration.kind.class\" title=\"{{configuration.kind.title}}\"></span>\n            </div>\n            <div class=\"list-view-pf-body\">\n              <div class=\"list-view-pf-description\">\n                <div class=\"list-group-item-heading\">\n                  {{configuration.name}}\n                </div>\n                <div class=\"list-group-item-text\">\n                  {{configuration.description}}\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div class=\"list-group-item list-view-pf-stacked child\" ng-if=\"configuration.isFactory\"\n           ng-repeat=\"child in configuration.children\">\n        <div class=\"list-group-item-header\" ng-click=\"goTo(child.pidLink)\">\n          <div class=\"list-view-pf-main-info\">\n            <div class=\"list-view-pf-left\">\n              <span class=\"list-view-pf-icon-sm\" ng-class=\"child.kind.class\" title=\"{{child.kind.title}}\"></span>\n            </div>\n            <div class=\"list-view-pf-body\">\n              <div class=\"list-view-pf-description\">\n                <div class=\"list-group-item-heading\">\n                  {{child.name}}\n                </div>\n                <div class=\"list-group-item-text\">\n                  {{child.description}}\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n\n  <div modal=\"addPidDialog.show\" close=\"addPidDialog.close()\" options=\"addPidDialog.options\">\n    <form name=\"addPidDialogForm\" class=\"form-horizontal no-bottom-margin\" ng-submit=\"addPid(newPid)\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" aria-label=\"Close\" ng-click=\"addPidDialog.close()\">\n          <span class=\"pficon pficon-close\" aria-hidden=\"true\"></span>\n        </button>\n        <h4>Add Configuration</h4>\n      </div>\n      <div class=\"modal-body\">\n        <div class=\"form-group\">\n          <label class=\"col-sm-3 control-label\" for=\"newPid\">Configuration ID</label>\n          <div class=\"col-sm-9\">\n            <input type=\"text\" id=\"newPid\" class=\"form-control\" ng-model=\"newPid\"/>\n          </div>\n        </div>\n      </div>\n      <div class=\"modal-footer\">\n        <button type=\"button\" class=\"btn btn-default\" ng-click=\"addPidDialog.close()\">Cancel</button>\n        <button type=\"submit\" class=\"btn btn-primary\" ng-disabled=\"!(newPid !== \'\' && newPid !== undefined)\">Add</button>\n      </div>\n    </form>\n  </div>\n</div>\n");
$templateCache.put("plugins/osgi/html/framework.html","<h1>Framework Configuration</h1>\n\n<div class=\"container\" ng-controller=\"Osgi.FrameworkController\">\n\n  <div class=\"row\">\n    <div class=\"col-md-12\">\n      <dl class=\"dl-horizontal framework-configuration\">\n        <dt>\n          Current Framework Start Level\n        </dt>\n        <dd>\n          <editable-property ng-model=\"config\" property=\"startLevel\" type=\"number\" min=\"0\" max=\"100\"\n                             on-save=\"startLevelChanged()\"></editable-property>\n        </dd>\n        <dt>\n          Initial Bundle Start Level\n        </dt>\n        <dd>\n          <editable-property ng-model=\"config\" property=\"initialBundleStartLevel\" type=\"number\" min=\"0\" max=\"100\"\n                             on-save=\"initialBundleStartLevelChanged()\"></editable-property>\n        </dd>\n      </dl>\n    </div>\n  </div>\n\n</div>\n");
