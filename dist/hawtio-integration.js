...
/// <reference path="../libs/hawtio-jmx/d.ts/jmx/ts/graphs.d.ts"/>
...
var Osgi;
(function (Osgi) {
    var OsgiGraphBuilder = /** @class */ (function () {
        ...
        OsgiGraphBuilder.prototype.addFilteredBundles = function () {
            ...
            d3.values(this.getBundles()).forEach(function (bundle) {
                if (_this.bundleFilter == null || _this.bundleFilter == "" || _.startsWith(bundle.SymbolicName, _this.bundleFilter)) {
        ...
        OsgiGraphBuilder.prototype.addFilteredPackages = function () {
            ...
            if (this.showPackages) {
                d3.values(this.getPackages()).forEach(function (pkg) {
                    if (_this.packageFilter == null || _this.packageFilter == "" || _.startsWith(pkg.Name, _this.packageFilter)) {
