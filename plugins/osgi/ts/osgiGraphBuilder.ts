...
//                },
        ...
        addFilteredBundles() {
            ...
            d3.values(this.getBundles()).forEach( (bundle) => {
                ...
                if (this.bundleFilter == null || this.bundleFilter == "" || _.startsWith(bundle.SymbolicName, this.bundleFilter)) {
        ...
        addFilteredPackages() {
            ...
            if (this.showPackages) {
                d3.values(this.getPackages()).forEach( (pkg) => {
                    ...
                    if (this.packageFilter == null || this.packageFilter == "" || _.startsWith(pkg.Name, this.packageFilter)) {
