...
![Camel Tree](plugins/camel/doc/img/camel-tree.png "Camel Tree")

And on the main view area is a table that lists runtime metrics of each Camel application, as shown below:

![Camel Attributes](plugins/camel/doc/img/context-attributes.png "Camel Attributes")
...
![Route Attributes](plugins/camel/doc/img/route-attributes.png "Route Attributes")
...
![Select Route](plugins/camel/doc/img/route-select.png "Select Route")
...
![Route Diagram](plugins/camel/doc/img/route-diagram.png "Route Diagram")
...
![Route Source](plugins/camel/doc/img/route-source.png "Route Source")
...
![Route Updated](plugins/camel/doc/img/route-updated.png "Route Updated")
...
![Route Debug](plugins/camel/doc/img/route-debug-0.png "Route Debug")

... and on the left hand side is buttons to control the debugging.

![Route Debug Control Panel](plugins/camel/doc/img/route-debug-1.png "Route Debug Control Panel")
...
![Route Debug Breakpoint Suspended](plugins/camel/doc/img/route-debug-2.png "Route Debug Breakpoint Suspended")
...
Clicking on the ![Step Button](plugins/camel/doc/img/debug/step.gif "Step Button") will advance the message to the next node, which
in this example is the *messageOthers* node as shown below:

![Route Debug Others](plugins/camel/doc/img/route-debug-3.png "Route Debug at messageOthers")

By clicking on the ![Resume Button](plugins/camel/doc/img/debug/resume.gif "Step Resume") would continue routing the message, until
...
![Route Trace](plugins/camel/doc/img/route-trace-0.png "Route Trace")
...
![Route Trace Message](plugins/camel/doc/img/route-trace-1.png "Route Trace Message")

Using the control buttons we can navigate forward and backward the traced message at the actual path the message went.

![Route Trace Control Buttons](plugins/camel/doc/img/route-trace-control.png "Route Trace Control Buttons")
...
![Route Trace Message 2](plugins/camel/doc/img/route-trace-2.png "Route Trace Message 2")
...
![Route Profile](plugins/camel/doc/img/route-profile.png "Route Profile")
...
![Route Metrics](plugins/camel/doc/img/route-metrics.jpg "Route Metrics")
...
![Endpoint Tree](plugins/camel/doc/img/endpoint-tree.png "Endpoint Tree")

And on the main view area is a table that lists the endpoints in tabular format as well.

![Endpoint Table](plugins/camel/doc/img/endpoint-table.png "Endpoint Table")
...
![Endpoint Browsable](plugins/camel/doc/img/endpoint-file-browse-1.png "Endpoint Browsable")

.. by clicking the message id, brings up the message, and a control panel on the right hand side.

![Endpoint Browse](plugins/camel/doc/img/endpoint-file-browse-2.png "Endpoint Browse")
...
![Endpoint Send](plugins/camel/doc/img/endpoint-file-send-1.png "Endpoint Send")
...
![Endpoint Send](plugins/camel/doc/img/endpoint-file-send-2.png "Endpoint Send")
...
![Endpoint Send](plugins/camel/doc/img/endpoint-file-send-3.png "Endpoint Send")
