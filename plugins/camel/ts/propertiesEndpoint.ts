...
module Camel {
  ...
  _module.controller("Camel.PropertiesEndpointController", ["$scope", "workspace", "localStorage", "jolokia", "documentBase", ($scope, workspace:Workspace, localStorage:WindowLocalStorage, jolokia, documentBase) => {
